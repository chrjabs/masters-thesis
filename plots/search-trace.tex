...
\node [label=$\sol^c_1$] at (3,3) {};
\node [label=$\sol^c_2$] at (2,3) {};
\node [label=left:$\sol^c_3$] at (1,3) {};
\node [label=left:$\sol^o_1$] at (1,2) {};
\node [label=below:$\sol^c_4$] at (3,1) {};
\node [label=below:$\sol^o_2$] at (2,1) {};
