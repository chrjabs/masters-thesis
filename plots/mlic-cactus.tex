...
\addplot [semithick,color3,dashed,mark=-] table [x=nsolved,y=paretosat-us,col sep=comma] {mlic-cactus.csv};
\addlegendentry{\unsatsat}

\addplot [semithick,color2,dashdotted,mark=star] table [x=nsolved,y=paretosat-msu3,col sep=comma] {mlic-cactus.csv};
\addlegendentry{\msu}

\addplot [semithick,color0,solid,mark=asterisk] table [x=nsolved,y=paretosat-msh-70litsnobne,col sep=comma] {mlic-cactus.csv};
\addlegendentry{\msh}

\addplot [semithick,color1,dashed,mark=+] table [x=nsolved,y=paretosat-su,col sep=comma] {mlic-cactus.csv};
...
\addplot [semithick,color4,dashdotted,mark=|] table [x=nsolved,y=paretosat-oll,col sep=comma] {mlic-cactus.csv};
\addlegendentry{\oll}

\addplot [semithick,color6,dashed,mark=o] table [x=nsolved,y=seesaw,col sep=comma] {mlic-cactus.csv};
