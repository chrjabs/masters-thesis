...
\addplot [only marks,color0,mark=x] table [x=paretosat-msh,y=paretosat-msh-bne,col sep=comma] {setcover-element-prob-bne-scatter-single.csv};
\addlegendentry{\scep{}}

\addplot [only marks,color1,mark=o] table [x=paretosat-msh,y=paretosat-msh-bne,col sep=comma] {setcover-set-card-bne-scatter-single.csv};
\addlegendentry{\scsc{}}

\addplot [only marks,color2,mark=+] table [x=paretosat-msh,y=paretosat-msh-bne,col sep=comma] {mlic-bne-scatter-single.csv};
...
\addplot [only marks,color0,mark=x] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsdisjoint,col sep=comma] {setcover-element-prob-disjoint-scatter-single.csv};

\addplot [only marks,color1,mark=o] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsdisjoint,col sep=comma] {setcover-set-card-disjoint-scatter-single.csv};

\addplot [only marks,color2,mark=+] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsdisjoint,col sep=comma] {mlic-disjoint-scatter-single.csv};
