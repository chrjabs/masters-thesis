...
\nextgroupplot[
  ...
  ymin=30,
  ymax=5400,
  xlabel={with lazy $\textsc{Tot}(\textsc{O}_\text{D})$ building (s)},
  ylabel={without lazy $\textsc{Tot}(\textsc{O}_\text{D})$ building (s)},
...
\addplot [only marks,color0,mark=x] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsnolazydown,col sep=comma] {setcover-element-prob-lazydown-scatter-single.csv};
\addlegendentry{\scep{}}

\addplot [only marks,color1,mark=o] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsnolazydown,col sep=comma] {setcover-set-card-lazydown-scatter-single.csv};
\addlegendentry{\scsc{}}

\addplot [only marks,color2,mark=+] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsnolazydown,col sep=comma] {mlic-lazydown-scatter-single.csv};
...
\nextgroupplot[
  ...
  ymin=30,
  ymax=5400,
  xlabel={heuristic core minimization (s)},
  ylabel={exact core minimization (s)},
  log ticks with fixed point,
  axis x line*=bottom,
  axis y line*=left,
  xtickten={2,3},
...
\addplot [only marks,color0,mark=x] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsconfmin,col sep=comma] {setcover-element-prob-confmin-scatter-single.csv};

\addplot [only marks,color1,mark=o] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsconfmin,col sep=comma] {setcover-set-card-confmin-scatter-single.csv};

\addplot [only marks,color2,mark=+] table [x=paretosat-msh-70lits,y=paretosat-msh-70litsconfmin,col sep=comma] {mlic-confmin-scatter-single.csv};
