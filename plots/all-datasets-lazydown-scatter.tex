...
\begin{axis}[
  ...
  tick pos=left,
  xlabel={with Lazy Down Tot Building (s)},
  ylabel={without Lazy Down Tot Building (s)},
  xmin=0,
  xmax=5400,
  ymin=0,
  ymax=5400,
  ...
  extra x ticks={5400},
  extra x tick labels={5.4},
  ytick={0,1000,2000,3000,4000,5000},
  extra y ticks={5400},
  extra y tick labels={5.4},
]

\draw [dotted] (0,0) -- (5400,5400);
\draw [loosely dotted] (0,0) -- (5400,2700);
\draw [loosely dotted] (0,0) -- (2700,5400);

\addplot [only marks,color0,mark=x] table [x=paretosat-msh,y=paretosat-msh-nolazydown,col sep=comma] {setcover-element-prob-lazydown-scatter.csv};
\addlegendentry{SetCovering-EP}

\addplot [only marks,color1,mark=o] table [x=paretosat-msh,y=paretosat-msh-nolazydown,col sep=comma] {setcover-set-card-lazydown-scatter.csv};
\addlegendentry{SetCovering-SC}

\addplot [only marks,color2,mark=+] table [x=paretosat-msh,y=paretosat-msh-nolazydown,col sep=comma] {mlic-lazydown-scatter.csv};
