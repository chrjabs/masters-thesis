...
\addplot [semithick,color0,solid,mark=asterisk] table [x=nsolved,y=paretosat-msh-70litsposnobne,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{\msh}

\addplot [semithick,color1,dashed,mark=+] table [x=nsolved,y=paretosat-su,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{\satunsat}

\addplot [semithick,color2,dashdotted,mark=star] table [x=nsolved,y=paretosat-msu3,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{\msu}

\addplot [semithick,color3,dashed,mark=-] table [x=nsolved,y=paretosat-us,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{\unsatsat}

\addplot [semithick,color5,solid,mark=x] table [x=nsolved,y=pminimal,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{$P$-minimal}

\addplot [semithick,color4,dashdotted,mark=|] table [x=nsolved,y=paretosat-oll,col sep=comma] {setcover-element-prob-cactus.csv};
\addlegendentry{\oll}
...
\addplot [semithick,color0,solid,mark=asterisk] table [x=nsolved,y=paretosat-msh-70litsposnobne,col sep=comma] {setcover-set-card-cactus.csv};

\addplot [semithick,color2,dashdotted,mark=star] table [x=nsolved,y=paretosat-msu3,col sep=comma] {setcover-set-card-cactus.csv};

\addplot [semithick,color4,dashdotted,mark=|] table [x=nsolved,y=paretosat-oll,col sep=comma] {setcover-set-card-cactus.csv};

\addplot [semithick,color1,dashed,mark=+] table [x=nsolved,y=paretosat-su,col sep=comma] {setcover-set-card-cactus.csv};

\addplot [semithick,color5,solid,mark=x] table [x=nsolved,y=pminimal,col sep=comma] {setcover-set-card-cactus.csv};

\addplot [semithick,color3,dashed,mark=-] table [x=nsolved,y=paretosat-us,col sep=comma] {setcover-set-card-cactus.csv};
