...
\begin{axis}[
  ...
  tick pos=left,
  xlabel={Heuristic Conf Min (s)},
  ylabel={Exact Conf Min (s)},
  xmin=0,
  xmax=5400,
  ymin=0,
  ymax=5400,
...
\addplot [only marks,color0,mark=x] table [x=paretosat-msh,y=paretosat-msh-confmin,col sep=comma] {setcover-element-prob-confmin-scatter.csv};
\addlegendentry{SetCovering-EP}

\addplot [only marks,color1,mark=o] table [x=paretosat-msh,y=paretosat-msh-confmin,col sep=comma] {setcover-set-card-confmin-scatter.csv};
\addlegendentry{SetCovering-SC}

\addplot [only marks,color2,mark=+] table [x=paretosat-msh,y=paretosat-msh-confmin,col sep=comma] {mlic-confmin-scatter.csv};
