...
\addplot [only marks,color0,mark=x] table [x=pminimal,y=paretosat-msh-70litsposnobne,col sep=comma] {setcover-element-prob-msh-scatter.csv};
\addlegendentry{\scep{}}

\addplot [only marks,color1,mark=o] table [x=pminimal,y=paretosat-msh-70litsposnobne,col sep=comma] {setcover-set-card-msh-scatter.csv};
\addlegendentry{\scsc{}}

\addplot [only marks,color2,mark=+] table [x=pminimal,y=paretosat-msh-70litsnobne,col sep=comma] {mlic-msh-scatter.csv};
