...
\usepackage[style=numeric,bibstyle=authoryear,backend=biber,natbib=true,maxnames=99,maxcitenames=2,uniquelist=minyear,giveninits=true,uniquename=mininit,safeinputenc]{biblatex}
...
\Crefrangeformat{ALC@unique}{Lines~#3#1#4--#5#2#6}
...
\include{Ch.20_Preliminaries}
\include{Ch.30_The_Approach}
\include{Ch.40_Other_Approaches}
\include{Ch.50_Experiments}
...
%% A sample Appendix
\include{Ch.90_Appendix_Datasets}
