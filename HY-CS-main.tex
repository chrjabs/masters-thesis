...
\usepackage[style=numeric,backend=biber,natbib=true,maxnames=99,maxcitenames=2,uniquelist=minyear,giveninits=true,uniquename=mininit,safeinputenc,sorting=none]{biblatex}
