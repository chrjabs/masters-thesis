...
\begin{example}\label{ex:sat-modelling}
  ...
  The semantics of these variables are that if and only if an assignment $\sol$ assigns $\sol(v)=1$, then the element that this variable is included in the cover the assignment encodes.
