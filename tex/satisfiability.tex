...
The specific works that this thesis builds on are the solution-improving \satunsat{}~\autocite{DBLP:journals/jsat/BerreP10}, the lower-bounding \unsatsat{}~\autocite{}, and the core-guided \msu{}~\autocite{DBLP:journals/corr/abs-0712-1097} and \oll{}~\autocite{DBLP:conf/cp/MorgadoDM14} algorithms.

\section{Encoding Cardinality Constraints as Totalizers\label{sec:card-const}}

% Cardinality constraints
The algorithmic approach presented in this thesis makes heavy use of cardinality constraints.
...
Numerous methods of forming such CNF formulas are known (e.g.,~\autocite{DBLP:conf/cp/BailleuxB03,DBLP:conf/cp/Sinz05,DBLP:journals/jsat/EenS06}).
