...
\begin{example}\label{ex:sat-modelling}
  ...
  you have three guests coming over and want to make a pizza that contains something that each person likes.
...
\begin{example}\label{ex:inc-sat}
  ...
  To check if we can still make a pizza with only two ingredients such that every Guest likes at least one of the ingredients, we can use incremental SAT solving.
