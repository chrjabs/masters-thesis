...
Our implementation is available as open source at \url{https://bitbucket.org/coreo-group/bioptsat/}.
...
In our implementation we extend $P$-minimal to the task of enumerating all solutions in the Pareto front.
