...
% Simulated annealing
The first category of inexact algorithms is the family of simulated annealing algorithms~\autocite{Saini2021}.
...
These meta-heuristic algorithms hold a set of candidate solutions referred to as \emph{population}, which is then developed over multiple iterations to inexact the Pareto front;
