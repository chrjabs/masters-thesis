...
For this reason, and since these problems are typically computationally hard, there is a need for non-trivial algorithmic solutions for solving combinatorial optimization.
Many such solutions (e.g., local search, evolutionary algorithms of declarative programming) have been presented for optimization problems with a single objective, however, real-world problems are often inherently bi-objective.
...
We present and evaluate five different variants of \algname{}, all building on different algorithms known from MaxSAT solving.
