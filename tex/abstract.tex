...
Less work has been done on approaches for optimization problems with \emph{multiple} objectives.
...
It allows for solving three tasks for bi-objective optimization:
