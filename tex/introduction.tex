...
\TODO{Maybe move approaches and declarative stuff here.}
\TODO{Transition by saying that we focus on bi-objecitve.}
\TODO{Mention hardness.}
...
A plethora of algorithmic approaches to solving optimization problems have been proposed, ranging from stochastic local search~\autocite{}, over evolutionary~\autocites{Dasgupta2013,DBLP:journals/jgo/StornP97} to declarative algorithms~\autocite{}.
...
Examples of declarative languages are maximum satisfiability~\autocite{handbook2-maxsat} and mixed integer linear programming~\autocites{ChenEtAl2010AppliedIntegerProgramming,KorteVygen2018-5}.
