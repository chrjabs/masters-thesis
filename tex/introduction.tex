...
In the same way that there are different complexity classes for decision problems~\autocite{AroraBarak2009-complexity}, these complexity classes can be extended to optimization problems as well.
